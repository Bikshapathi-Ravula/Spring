...
public class ShipmentDataService {
    ...
    public ShipmentData createShipment(ShipmentData shipmentData) throws JsonGenerationException, JsonProcessingException {
        // You can add any specific business logic or validation before saving
    	
    	ShipmentData mappedShipmentData = om.readValue(om.writeValueAsString(shipmentData), ShipmentData.class);
//    	System.out.println(om.writeValueAsString(shipmentData));
    	
    	kafkaService.sendData(om.writeValueAsString(shipmentData));
        return mappedShipmentData;
    }
